...
const Card = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`w-64 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 ${className}`}
    >
      <div
      ...
      <div className="p-4 bg-secondary flex flex-col justify-between min-h-[140px]">
        ...
        <div className="flex justify-between items-center">
          ...
          <TimerBadge minutes={time} color="text-gray-500" />
        </div>
        {children}
      </div>
    </div>
