...
const UserManagement = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      {/* Aquí irá la tabla de gestión de usuarios */}
      <div className="overflow-x-auto">
        <table className="min-w-full bg-white border border-gray-200">
          <thead>
            <tr>
              <th className="py-2 px-4 border-b text-left text-sm font-semibold text-gray-600">ID & Name</th>
              <th className="py-2 px-4 border-b text-left text-sm font-semibold text-gray-600">Email Address</th>
              <th className="py-2 px-4 border-b text-left text-sm font-semibold text-gray-600">Account Type</th>
          ...
          <tbody>
            {/* Filas de ejemplo */}
            <tr>
              <td className="py-2 px-4 border-b text-sm text-gray-700">1. John Doe</td>
              <td className="py-2 px-4 border-b text-sm text-gray-700">john.doe@example.com</td>
              <td className="py-2 px-4 border-b text-sm text-gray-700">Admin</td>
