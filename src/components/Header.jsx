...
//logica para determinar la direccion a la que se redirige el logo condicionalmente
// si el usuario esta logueado, lo redirige a /main, si no, a / . Esta sin comprobar hasta que se implemente el login.
const LogoTitle = () =>{
