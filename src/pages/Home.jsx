...
const Home = () => {
    ...
    const latestRecipes = [...mockRecipes].sort((a, b) => new Date(b.created_at) - new Date(a.created_at)).slice(0, 3);
    const { favorites, toggleFavorite } = useFavorites();

    return (
        <div className="min-h-screen bg-background w-full" data-testid="home-page">
            <div className="w-full bg-background pt-16 pb-12 px-4 sm:px-6 lg:px-8" id="home-header">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-left">
                        <p className="text-gray-600 mb-2" data-testid="prompt-text">
                            ¿No sabes que elegir?
                        </p>
                        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6" data-testid="main-title">
                            ¿Qué te apetece?
                        </h1>
                        <div
