  ...
  const renderContent = () => {
    switch (activeSection) {
      case 'dashboard':
        return (
          <div className="p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Dashboard Principal</h2>
      ...
      default:
        return (
          <div className="p-6">
            ...
            <p className="text-gray-600">Bienvenido al dashboard de administración.</p>
          </div>
        );
    }
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-100"> {/* Fondo general del dashboard */}
      ...
      <div className="w-64 bg-white shadow-lg p-6 flex flex-col">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800">Recipe Admin</h1>
        </div>
